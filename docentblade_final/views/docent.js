...
class Docent {
    constructor(docentName, course, score, bestReco, captainReco, deadReco, comments, register) {
    ...
    static createFromObject(obj) {
        ...
        let docent = new Docent(newDocent._docentName, newDocent._course, newDocent._score, newDocent._bestReco, newDocent._captainReco, newDocent._deadReco, newDocent._comments, newDocent._register)
        docent._docentID = newDocent._docentID;
        return docent;
    }

    static cleanObj(obj) {
        const docentProperties = ['_docentName', '_course', '_score', '_bestReco', '_captainReco', '_deadReco', '_comments', '_register'];
        for (let prop in obj) {
            let verificador = 0;
